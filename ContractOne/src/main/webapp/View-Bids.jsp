...
<form action="UpdateJob" method="post">
	<label for="newsletter">Accept Bid / Delete Job</label>
		<br><br>
		<div class="full-width">
      <label for="bidID">BidID</label>
      <input id="bidID" type="text" name = "bidID" />
    </div>
    <div>
    <label for="status">Accept/Delete</label>
    <input id = "status" type = "hidden">
		<select name="status" id="status" >
  			<option value="archive">Accept</option>
